...
<div class="container">
    ...
    <div class="header">
        <div class="row">
            <div class="logo fl"><a href="/" title="<?php echo $web_title;?>_在线漫画欣赏尽在绿色<?php echo $web_title;?>">
<?php echo $web_title;?>
</a></div>
            <div class="search-form">
                <form action="/search/index/" method="get" >
                    <input type="text" id="keyword" autocomplete="off" class="search-wrod" name="q" placeholder="请输入需要搜索的漫画关键词" x-webkit-speech="" speech="" value="<?php echo $q;?>"/>
...
?>
  <li>
    <div class="li-title">
       <a href="/index/comic/<?php echo $row['url'];?>" class="title h3" title="<?php echo strip_tags($row['title']);?>"><?php echo $row['title'];?></a>
            ...
            <div class="sub-tab-box mt10">
                <div class="sub-title">
                    ...
                    <ul class="mod-tab" rel="xtaberTabs">
                        <li rel="xtaberTabItem" class="current">热门</li>
                        <li rel="xtaberTabItem">精彩</li>
                    </ul>
                </div>
...
<script type="text/javascript" src="<?php echo $cdn_url;?>/public/js/jquery.xhover.js"></script>
