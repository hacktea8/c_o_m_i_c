...
<li><span class="t1"><?php echo $key+1;?>.</span><a href="<?php echo $row['url'];?>" target="_blank" title="<?php echo $row['name'];?>"><?php echo $row['name'];?></a></li>
<?php } ?>
</ul>
</div>
...
<h2 class="bar"><span class="orderNav"><em>排序：</em> <a
	href="/index/cate/<?php echo $cid;?>/atime/<?php echo $page;?>" title="添加时间" class="<?php echo $order === 'atime'?'on':'';?>">添加时间</a> | <a
	href="/index/cate/<?php echo $cid;?>/rtime/<?php echo $page;?>" title="更新时间" class="<?php echo $order === 'rtime'?'on':'';?>">更新时间</a> | <a
	href="/index/cate/<?php echo $cid;?>/hits/<?php echo $page;?>" title="点击次数" class="<?php echo $order === 'hits'?'on':'';?>">点击次数</a></span><strong><a
